"""Tests for the FormSpec authored for BaseloadConfig (static baseload).
...
def test_form_spec_builds_into_a_descriptor() -> None:
    descriptor = build_descriptor(
        "baseload_static", "Baseload (static profile)", BaseloadConfig, BASELOAD_CONFIG_FORM_SPEC
    )

    assert descriptor.owner_id == "baseload_static"
