"""Tests for the FormSpec authored for BaseloadConfig (homeassistant baseload).
...
def test_form_spec_builds_into_a_descriptor() -> None:
    descriptor = build_descriptor(
        "baseload_ha", "Baseload (Home Assistant)", BaseloadConfig, BASELOAD_CONFIG_FORM_SPEC
    )

    assert descriptor.owner_id == "baseload_ha"
