...
class HaConfig(BaseModel):
    ...
    db_url: str = Field(description="SQLAlchemy database URL pointing to the HA recorder database.")
...
class BaseloadConfig(BaseModel):
    ...
    homeassistant: HaConfig = Field(description="HA recorder database connection and entity configuration.")
