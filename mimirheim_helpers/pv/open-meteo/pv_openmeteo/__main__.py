...
``PvOpenMeteoDaemon`` also opts into the Config Service protocol via
...
CONFIG_OWNER_ID = "pv_open_meteo"
CONFIG_OWNER_DISPLAY_NAME = "PV forecast (Open-Meteo)"
...
class PvOpenMeteoDaemon(HelperDaemon):
    ...
    def __init__(self, config: PvOpenMeteoConfig, config_path: Path) -> None:
